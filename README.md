...
| EP08 | A Fazenda Agora Cresce Sozinha | Game speed control with T key hold (velocidadeTempo variable), debug speed multiplier, accelerated crop growth simulation, event handling fix (SDL_KEYDOWN/KEYUP nesting) | [`ep08-accelerated-time-system`](https://github.com/harlleybastos/colheita-feliz-cpp/tree/ep08-accelerated-time-system) | [Watch](https://youtu.be/nzBNxl-gdrk) |
| EP09 | TRANSFORMEI minha FAZENDA em NEGÓCIO | Hot-reload com DLL (Handmade Hero pattern), config.ini runtime via F5, eventos aleatórios (seca, erva daninha, minhoca) com sprites animados 8fps, Loja de sementes (tecla L), Depósito vendedor (tecla D), modo compra de canteiros (tecla B), tooltips modernos, sombras em tiles e sprites, sistema de inventário e ouro | [`ep09-economia-eventos`](https://github.com/harlleybastos/colheita-feliz-cpp/tree/ep09-economia-eventos) | [Watch](https://youtu.be/oWTvi2W3TXg) |
