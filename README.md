...
| EP06 | Toolbar + Sistema de Ferramentas | Barra de ferramentas com 7 ícones, enum Ferramenta, struct Toolbar, hit testing, ações contextuais por ferramenta × estado (enxada limpa restos, sacola planta, mão colhe) | [`ep06-toolbar-ferramentas`](https://github.com/harlleybastos/colheita-feliz-cpp/tree/ep06-toolbar-ferramentas) | [Watch](https://youtu.be/BdXGabPxh04) |
